...
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_arrivepod_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_arrivetransship_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_booketapod_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_booketdpol_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_btapod_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_btdpol_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_create_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_customsreleased_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_departpol_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_departtransship_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_emptycontainerreturn_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_fullcontainerdelivery_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_fullcontainerdischarge_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_fulloutgateocean_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_onboard_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_outforstuffing_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_yardin_owner_agg_temp;
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_yardout_owner_agg_temp;

CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_outforstuffing_owner_agg_temp
...
,   COALESCE(a.ownerorgid, b.ownerorgid) AS ownerorgid
,   COALESCE(a.ownerorgname, b.ownerorgname) AS ownerorgname
...
FROM hv_orc_emptyoutgate_owner_agg AS a
    FULL OUTER JOIN hv_orc_outforstuffing_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_yardin_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_outforstuffing_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_yardin_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_onboard_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_yardin_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_onboard_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_booketdpol_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_onboard_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_booketdpol_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_btdpol_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
,   b.teuatpodranksum
,   b.teuatpodrankcount
FROM hv_orc_ocm_benchmark_booketdpol_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_btdpol_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_departpol_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_btdpol_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_departpol_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_arrivetransship_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_departpol_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_arrivetransship_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_departtransship_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_arrivetransship_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_departtransship_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_btapod_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
,   b.teuatpodsum
FROM hv_orc_ocm_benchmark_departtransship_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_btapod_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_booketapod_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_btapod_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_booketapod_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_arrivepod_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_booketapod_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_arrivepod_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_customsreleased_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_arrivepod_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_customsreleased_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_fullcontainerdischarge_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_customsreleased_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_fullcontainerdischarge_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_yardout_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_fullcontainerdischarge_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_yardout_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_fulloutgateocean_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_yardout_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_fulloutgateocean_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_fullcontainerdelivery_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_fulloutgateocean_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_fullcontainerdelivery_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_emptycontainerreturn_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_fullcontainerdelivery_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_emptycontainerreturn_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
CREATE TABLE IF NOT EXISTS hv_orc_ocm_benchmark_create_owner_agg_temp
STORED AS ORC TBLPROPERTIES("orc.compress" = "SNAPPY")
AS
SELECT
    COALESCE(a.carrierorgid, b.carrierorgid) AS carrierorgid
...
FROM hv_orc_ocm_benchmark_emptycontainerreturn_owner_agg_temp AS a
    FULL OUTER JOIN hv_orc_create_owner_agg AS b
    ON a.carrierorgid = b.carrierorgid
    AND a.ownerorgid = b.ownerorgid
    AND a.podcityid = b.podcityid
    AND a.polcityid = b.polcityid
...
DROP TABLE IF EXISTS hv_orc_ocm_benchmark_owner_agg;

ALTER TABLE hv_orc_ocm_benchmark_create_owner_agg_temp RENAME TO hv_orc_ocm_benchmark_owner_agg;
