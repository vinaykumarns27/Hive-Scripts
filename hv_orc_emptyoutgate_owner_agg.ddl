...
DROP TABLE IF EXISTS hv_orc_emptyoutgate_owner_agg_temp;

CREATE TABLE IF NOT EXISTS hv_orc_emptyoutgate_owner_agg_temp
...
DROP TABLE IF EXISTS hv_orc_emptyoutgate_owner_agg;

ALTER TABLE hv_orc_emptyoutgate_owner_agg_temp RENAME TO hv_orc_emptyoutgate_owner_agg;