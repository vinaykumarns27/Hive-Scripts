...
DROP TABLE IF EXISTS hv_orc_arrivetransship_no_owner_agg_temp;

CREATE TABLE IF NOT EXISTS hv_orc_arrivetransship_no_owner_agg_temp
...
,   COUNT(arrivetransshiptime) AS arrivedattransshipmentcontainercount
FROM hv_orc_tt_vmcontainermove_no_owner_base AS a
    INNER JOIN dimension_common.hv_ext_tt_dw_date_dim AS b
    ON b.the_date = to_date(a.arrivetransshiptime)
...
DROP TABLE IF EXISTS hv_orc_arrivetransship_no_owner_agg;

ALTER TABLE hv_orc_arrivetransship_no_owner_agg_temp RENAME TO hv_orc_arrivetransship_no_owner_agg;